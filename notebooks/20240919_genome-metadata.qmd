...
downloaded.genome.ls.tbl <- inner_join(new.download.df, genome.ls.tbl, relationship = "many-to-many", by = "genome.genome_id") 

# combine with file metadata
downloaded.genome.ls.tbl <- left_join(downloaded.genome.ls.tbl, file_info.tbl, by = "destfile") 
